...
# ------------------------
def search_query(user_query, language="English"):
    # Map language to Excel columns
    query_col = f"Query_{language}"
    short_col = f"Short_{language}"
    detailed_col = f"Detailed_{language}"
    ...
    return best_match[query_col], best_match[short_col], best_match[detailed_col]
